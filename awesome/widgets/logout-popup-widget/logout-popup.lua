	...
	capi.keygrabber.run(function(_, key, event)
		...
		if key then
			if key == "Escape" then
				...
				if key == onpoweroff_key then
					onpoweroff()
				elseif key == onreboot_key then
					onreboot()
				elseif key == onsuspend_key then
					onsuspend()
				elseif key == onlock_key then
					onlock()
				elseif key == onlogout_key then
					onlogout()
				end
